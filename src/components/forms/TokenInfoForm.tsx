...
const TokenInfoForm: React.FC<TokenInfoFormProps> = ({ projectId, onCompletionUpdate }) => {
  ...
  const fields = [
    { id: 'initialMarketCapExLiquidity', label: 'Initial Market Cap (ex. liquidity)', type: 'text', placeholder: 'e.g. $1,000,000' },
    { id: 'initialMarketCap', label: 'Initial Market Cap (total)', type: 'text', placeholder: 'e.g. $1,200,000' },
    { id: 'fullyDilutedMarketCap', label: 'Fully Diluted Market Cap', type: 'text', placeholder: 'e.g. $10,000,000' },
    { id: 'circulatingSupplyAtTge', label: 'Circulating Supply at TGE', type: 'text', placeholder: 'e.g. 20,000,000' },
    { id: 'tgeSupplyPercentage', label: 'Circulating Supply at TGE (%)', type: 'text', placeholder: 'e.g. 20%' },
    { id: 'totalSupply', label: 'Total Supply', type: 'text', placeholder: 'e.g. 100,000,000' },
  ];
  ...
  const calculateCompletionPercentage = (data: FormData) => {
    ...
    if (onCompletionUpdate) {
      onCompletionUpdate('token-info', percentage);
    }
  };
  ...
  return (
    <div className="sleek-card p-6 form-container">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg font-medium text-text-primary">Token Info</h2>
